...
<link rel="stylesheet" type="text/css" media="screen" href="${ctp }css/global.css" />
		...
		$('#tt').tree({
			onClick: function(node){
				if(node.url=="${ctp }security-logout"){
					window.parent.parent.location = node.url;
				}else{
...
<body>
	...
	<table cellpadding=0 cellspacing=0>
      <tr>
        ...
        <td>
			<ul id="tt" class="easyui-tree" data-options="url:'${ctp }emp-navigate',method:'get',animate:true"></ul>
        </td>
      </tr>
    </table>
